...
import {
  View, Text, TextInput, TouchableOpacity, Keyboard, Image, Dimensions, TouchableWithoutFeedback, KeyboardAvoidingView, ScrollView
} from 'react-native'
...
const {
  container, flipCard, flipCardFront, flipCardBack, qrText, button, text, filterView, headerIcon, buttonText, cardImage, profileText, modalText, removeButton
} = style
...
class CompanyStudentCard extends Component {
      ...
      <ScrollView style={{ width: '100%', height: '100%' }}>
        <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
          <View style={flipCardFront}>
            <View style={{
              flex: 10, width: '100%', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', marginTop: 30
            }}
            >
            ...
            {!this.props.loading
              ? (
                <View style={{
                  flex: 10, width: '100%', padding: '5%', flexDirection: 'column', justifyContent: 'center', alignItems: 'center'
                }}
                >
              ...
              : null}
            <View style={{
              flex: 10, flexDirection: 'column', width: '100%', alignItems: 'center', justifyContent: 'center'
            }}
            >
              <View style={{
                flex: 5, width: '100%', justifyContent: 'center', alignItems: 'center', marginBottom: 4
              }}
              >
              ...
              <View style={{
                flex: 1, flexDirection: 'column', width: '100%', justifyContent: 'center', alignItems: 'center', marginBottom: 4, height: 90
              }}
              >
                <StarRating
                  disabled={false}
              ...
              <KeyboardAvoidingView
                behavior="padding"
                keyboardVerticalOffset={windowHeight * 0.45}
                enabled
                style={{
                  flex: 9, flexDirection: 'row', width: '100%', justifyContent: 'center', alignItems: 'center'
                }}
              >
                <View style={{ width: '100%' }}>
                  <TextInput
                    style={{
                      width: '100%', height: 200, borderColor: global.arkadBlue, borderWidth: 1, textAlignVertical: 'top', borderRadius: 8, paddingLeft: 7, paddingTop: 4, backgroundColor: '#fff', zIndex: 1000, marginBottom: 20
                    }}
    ...
    return (
      <View>
        <Modal
          ...
          style={{
            flex: 1, alignItems: 'center', justifyContent: 'center', paddingVertical: '19%', top: '8%'
          }}
        >
          <View style={{
            borderRadius: 8, backgroundColor: '#fff', flex: 1, alignItems: 'center', justifyContent: 'center', width: '100%'
          }}
          >
            <View style={{
              flex: 3, alignItems: 'center', justifyContent: 'center', width: '100%', height: '100%', paddingHorizontal: '3%'
            }}
            >
              <Text style={{ fontSize: 16 }}>Are you sure you want to remove this student?</Text>
            </View>
            <View style={{
              flex: 6, alignItems: 'center', justifyContent: 'center', width: '100%', height: '100%'
            }}
            >
              { studentInfo.profile_image == 'Not set'
                ? <Image style={cardImage} source={require('../../../resources/img/arkadTeam/default.png')} />
            ...
            <View style={{
              flex: 2, alignItems: 'center', justifyContent: 'center', width: '100%', height: '100%', flexDirection: 'row'
            }}
            >
              <View style={{
  ...
  unsavedModal() {
    return (
      <View>
        <Modal
          onBackdropPress={() => this.setState({ showUnsavedModal: false })}
          backdropTransitionOutTiming={0}
          isVisible={this.state.showUnsavedModal}
          style={{
            flex: 1, alignItems: 'center', justifyContent: 'center', paddingVertical: '30%'
          }}
        >
          <View style={{
            borderRadius: 8, backgroundColor: '#fff', flex: 1, alignItems: 'center', justifyContent: 'center', width: '100%'
          ...
          >
            <View style={{
              flex: 1, marginTop: 8, justifyContent: 'center', alignItems: 'center', width: '80%'
            }}
            >
              <Text style={{
                textAlign: 'center', marginBottom: 24, fontSize: 20, fontWeight: 'bold'
              }}
              >
                Unsaved changes
              </Text>
            ...
            <View style={{
              flex: 1, alignItems: 'center', justifyContent: 'center', width: '100%', height: '100%', flexDirection: 'row'
            }}
            >
              <View style={{
                flex: 1, alignItems: 'center', justifyContent: 'center', width: '100%', height: '100%'
              ...
              >
                <TouchableOpacity
                  style={{
                    marginHorizontal: 16, marginVertical: 8, justifyContent: 'center', alignItems: 'center', textAlign: 'center'
                  }}
    ...
    return (
      ...
      >
        {this.props.loading
          ? (
            <View style={{
              position: 'absolute', width: '100%', height: '100%', zIndex: 100, alignItems: 'center', justifyContent: 'center'
            }}
            >
              <LoadingView />
            </View>
