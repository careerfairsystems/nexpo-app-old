...
const {
  container, flipCard, flipCardFront, flipCardBack, qrText, button, text, filterView, headerIcon, buttonText, cardImage, profileText, modalText, starCount
} = style

function process(obj) {
  for (const i in obj) {
    const child = obj[i]
    if (child === '') obj[i] = 'Not set'
  ...
  return (
    <View style={flipCardFront}>
      <ScrollView style={{ flex: 1, width: '100%', height: '100%' }}>
        <View style={{
          flex: 5, width: '100%', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', marginTop: 30, height: '100%'
        }}
        >
        ...
        <View style={{
          flex: 10, width: '100%', padding: '5%', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', height: 150
        }}
        >
        ...
        <View style={{
          flex: 10, flexDirection: 'column', width: '100%', alignItems: 'center', justifyContent: 'center', height: 60
        }}
        >
          <View style={{
...
const StudentCard = ({
  student, navigation, typeLogedin, isLoading, myInfo, loading
}) => (
  <View style={{
